...
public class RecommendedGroupsAdapter extends RecyclerView.Adapter<RecommendedGroupsAdapter.ViewHolder> {
    private final List<StudyGroup> studyGroups;

    public RecommendedGroupsAdapter(List<StudyGroup> studyGroups, String userId) {
    ...
    public ViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.item_recommended_group, parent, false);
