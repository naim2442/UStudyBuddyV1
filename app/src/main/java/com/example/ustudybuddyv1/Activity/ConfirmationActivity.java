...
public class ConfirmationActivity extends AppCompatActivity {
    ...
    private TextView groupNameDisplay, groupSubjectDisplay, groupDescriptionDisplay, locationDisplay, tagsDisplay;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (studyGroup.getImageUrl() != null) {
            ...
            // For simplicity, we're assuming it's already loaded via URL in the model
